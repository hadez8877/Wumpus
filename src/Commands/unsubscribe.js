...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const buttons = new ActionRowBuilder().addComponents(
      new ButtonBuilder().setCustomId("ApproveEvent").setLabel("Sí").setStyle(ButtonStyle.Primary),

      new ButtonBuilder().setCustomId("DenyEvent").setLabel("No").setStyle(ButtonStyle.Secondary)
    );
